...
export const CARD = {
    ...
    title_layout: "flex gap-2 items-center",
    profile_initial: "rounded-full h-12 w-12 flex items-center justify-center font-light text-2xl bg-cyan-600 text-cyan-50",
    title_text: "text-lg font-medium text-white",
    title_text_xp: "text-xl font-bold text-white",
    ...
    list_text: "",
    content: "mt-3",
    content_section: "p-1 text-cyan-50 space-y-2 text-xs",
    ...
    tags: "inline-block px-1 text-xs font-medium rounded text-xs font-medium text-cyan-400",
...
export const VIEW = {
    ...
    title_text: "text-2xl font-bold text-cyan-400",
    title_icon: "h-6 w-6 text-cyan-400"
}

export const HEADER = {
    title: "flex items-center gap-2 h-full text-2xl font-bold text-cyan-400",
...
export const ICON = {
    ...
    lg: "w-8 h-8 text-cyan-400",
    xl: "w-10 h-10 text-cyan-400"
}
